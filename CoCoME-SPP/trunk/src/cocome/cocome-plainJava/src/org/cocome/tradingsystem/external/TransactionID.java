...
public final class TransactionID implements Serializable {
	...
	public int hashCode() {
		//
		// Calculate the hash code for the transaction id the same way the hash
		// code for Long is calculated, i.e. as the exclusive OR of the two
		// halves of the primitive {@code long} value representing the id.
		//
